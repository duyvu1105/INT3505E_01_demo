...
app.post("/api/auth/register", (req, res) => {
  ...
  const newUser = {
    id: nextUserId++,
    username,
    password, // CẢNH BÁO: Không bao giờ lưu plain password trong production
    email,
...
// GET /api/books - Lấy tất cả sách (KHÔNG yêu cầu xác thực)
...
// POST /api/books - Tạo sách mới (YÊU CẦU xác thực)
...
// PUT /api/books/:id - Cập nhật sách (YÊU CẦU xác thực)
...
// DELETE /api/books/:id - Xóa sách (YÊU CẦU xác thực)
